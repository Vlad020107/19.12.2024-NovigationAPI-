...
import ru.example.a19122024.databinding.FragmentRootBinding
...
class RootFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.ButtonRoot.setOnClickListener {
            val bundle =  Bundle()
            bundle.putString("season", "autumn")
            binding.root.findNavController().navigate(R.id.action_rootFragment_to_blankFragment, bundle)
        }
        return binding.root
    }
